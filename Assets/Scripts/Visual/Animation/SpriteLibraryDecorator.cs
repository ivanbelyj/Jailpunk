...
public class SpriteLibraryDecorator
{
    ...
    public string GetCategoryOrNull(AnimationParameters parameters, int? angle = null) {
        string category = SpriteLibraryUtils.GetCategoryName(parameters, angle);
    ...
    public bool HasCategoryForParameters(
        AnimationParameters parameters,
        int? angle = null) {
        return GetCategoryOrNull(parameters, angle) != null;
    }
