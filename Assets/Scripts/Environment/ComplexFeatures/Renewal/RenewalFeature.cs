...
public class RenewalFeature : ComplexFeature
{
    [SerializeField]
    ...
    /// <summary>
    /// All controlled objects in the complex that can be refreshed
    /// </summary>
    public IEnumerable<IRenewable> Refreshables => complex.Activatables
        .OfType<IRenewable>();
