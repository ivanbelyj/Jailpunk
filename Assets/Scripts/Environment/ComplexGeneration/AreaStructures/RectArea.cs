...
/// </summary>
[System.Serializable]
public class RectArea : IRectArea, ITraversableArea
{
    public enum Side {
        Left,
        Right,
    ...
    /// from the corner
    /// </summary>
    public Vector2Int GetSideRandomPoint(
        int offsetFromFirstCorner,
        int? offsetFromSecondCorner = null,
        bool? isOnVertSide = null,
        bool? isFirstBorder = null) {
        int x, y;
        offsetFromSecondCorner ??= offsetFromFirstCorner;
